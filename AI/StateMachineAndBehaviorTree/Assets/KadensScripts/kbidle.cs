...
public class kbidle : kbState
{
    public kbidle(GameObject _npc, NavMeshAgent _agent, Transform _player) : base(_npc, _agent, _player)
    {
        name = STATE.IDLE;
    }
    ...
    public override void Update()
    {
        ...
        {
            nextState = new kbPatrol(npc, agent, player);
            stage = EVENT.EXIT;
        }
